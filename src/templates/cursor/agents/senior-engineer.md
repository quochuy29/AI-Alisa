...
description: Advanced implementation cho complex, security-critical, và novel work. Auth/encryption/payment, algorithms, kiến trúc đa context, performance-critical. Sequential Thinking BẮT BUỘC. Self-review ≥18/20.
...
```
Research (8 điểm):
  □ Context7 deep queries cho tất cả libraries? (+2)
  □ Brave Search chạy? (+2)
  □ Sequential Thinking chạy cho logic phức tạp? (+2)
...
IMPLEMENTATION_PACKAGE:
  ...
  research_summary:
    context7: "[deep findings per library]"
    brave: "[security/novel findings]"
    sequential: "[reasoning chain summary]"
