...
○ 2025-11-09-0900-payment-gateway
  ...
  → Ready for: /requirements-specs-generate

○ 2025-11-08-1600-export-reports
  Phase: design_approved | Updated: 2d ago
  → Approved design, tasks pending. Fresh session → /requirements-specs-generate
...
- `/requirements-status` — Detailed status of active session
- `/requirements-current` — Full details of active session
- `/requirements-start [feature]` — Begin a new session
