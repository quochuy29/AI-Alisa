...
```
┌──────────────────────────────────────────────────────────────┐
│  #prompt:requirements-specs-execute (ORCHESTRATOR)                  │
├──────────────────────────────────────────────────────────────┤
...
4. Check for `COPILOT.md or CLAUDE.md` or `CLAUDE.md` for project conventions
...
1. `COPILOT.md or CLAUDE.md` / `CLAUDE.md` — project-specific conventions (HIGHEST)
...
12. Apply targeted code changes:
    ...
    - Follow ALL conventions from `COPILOT.md or CLAUDE.md`/`CLAUDE.md`
...
□ Conventions from COPILOT.md or CLAUDE.md followed?
...
To continue: Start a NEW Copilot Chat session → #prompt:requirements-specs-execute
...
2. Review code: #prompt:requirements-code-review
3. Archive session: #prompt:requirements-end
```
...
- `#prompt:requirements-specs-generate` — Generate design + tasks before executing
- `#prompt:requirements-revise` — Check code alignment with requirements/design
- `#prompt:requirements-status` — Check current session status
- `#prompt:requirements-bug-fix` — Fix bugs found during implementation
- `#prompt:requirements-end` — Archive completed session
