...
2. If no active session → show "No active session. Use #prompt:requirements-start to begin."
...
- `#prompt:requirements-status` — Quick progress dashboard
- `#prompt:requirements-remind` — Show phase-specific rules
- `#prompt:requirements-list` — All requirement sessions
