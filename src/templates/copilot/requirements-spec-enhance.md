...
**Usage**: `#prompt:requirements-spec-enhance [change description]`
...
Next: #prompt:requirements-specs-execute (start a new Copilot Chat session)
```
...
- `#prompt:requirements-specs-execute` — Resume task execution after change applied
- `#prompt:requirements-revise` — Check alignment after changes
- `#prompt:requirements-current` — View updated plan
- `#prompt:requirements-status` — Check current phase
