...
1. **Research TRƯỚC Code** — không bao giờ viết code mà chưa hoàn thành research
2. **Show Evidence** — luôn hiển thị research output trước khi implement
3. **Current APIs Only** — không dùng deprecated APIs khi đã có phiên bản mới
4. **Project Conventions First** — tuân theo patterns hiện có trong codebase trước generic best practices
