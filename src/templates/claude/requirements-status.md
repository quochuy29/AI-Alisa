...
| `requirements_complete` | Files 00-06 done | `/requirements-specs-generate` |
| `specs_generated` | Design pending approval | `/requirements-specs-generate` (approve design) |
| `design_approved` | Tasks pending | `/requirements-specs-generate` (fresh session) |
| `specs_complete` | Tasks ready | `/requirements-specs-execute` (new Claude Code session) |
| `executing` | Tasks in progress | `/requirements-specs-execute` (next task, new session) |
| `bug_fixing` | Bug open | `/requirements-bug-fix` |
| `change_review` | Change pending | `/requirements-spec-enhance` |
| `implemented` | All tasks done | `/requirements-code-review` or `/requirements-end` |
...
Run /requirements-specs-execute to resume verification of Task #[N].
...
- `/requirements-current` — View full session details and file listing
- `/requirements-list` — List all requirement sessions
